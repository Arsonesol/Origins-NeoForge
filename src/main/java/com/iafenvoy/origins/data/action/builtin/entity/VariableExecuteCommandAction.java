...
public record VariableExecuteCommandAction(String command, VariableSerializer variables) implements EntityAction, CommandHelper {
    ...
    @Override public void execute(@NotNull Entity source) { this.executeCommand(source, VariableStringUtil.parse(this.command, this.variables, source)); }
}
